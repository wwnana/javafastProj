...
public class SQLHelper {
    ...
    public static int getCount(final String sql, final Connection connection,
    	...
    	int  length = sql.indexOf("FROM")+ 4;
    	String sqlStr = sql.substring(length);
    	final String countSql = "select count(1) FROM" + removeOrders(sqlStr);
    	
    	//System.out.println("====列表查询SQL===="+sql);
    	//System.out.println("====总数查询SQL去ORDER BY===="+countSql);
