...
public class Page<T> {
	...
	private String searchBox;   //页面查询模式，默认是隐藏
...
//		sb.append("</div>");
		...
		sb.append("<li class=\""+getSelected(pageSize,20)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",20,'"+funcParam+"');\">20</a></li>");
...
//				"<option value=\"20\" "+getSelected(pageSize,20)+ ">20</option>" +
