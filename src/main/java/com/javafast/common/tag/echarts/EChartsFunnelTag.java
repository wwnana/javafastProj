package com.javafast.common.tag.echarts;
 ...
 *
 */
public class EChartsFunnelTag extends BodyTagSupport {
	...
	public int doEndTag() throws JspException {
		...
		sb.append("require([ 'echarts', 'echarts/chart/funnel'], function(ec) {");
		...
		// 数据轴封装并解析
				...
				if (orientData != null) {
					Line line = new Line();
					line.name(title).type(SeriesType.funnel);
