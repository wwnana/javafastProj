package com.javafast.common.servlet;
...
public class FileImageUploadServlet extends HttpServlet {
	...
	public static final String imgdir = Global.getConfig("userfiles.basedir")+"/userfiles/images";
	...
	public void init(ServletConfig config) throws ServletException {
		...
		filedir = Global.getUserfilesBaseDir() + "userfiles/images";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("======doGet========"+filedir);
		out.write(filedir);
	}
