...
//	}
	...
	public static String getFormUrl(String formKey, Act act){
		...
		formUrl.append("&act.projectId=").append(act.getProjectId() != null ? act.getProjectId() : "");
		formUrl.append("&act.project.name=").append(act.getProject().getName() != null ? act.getProject().getName() : "");
