package com.javafast.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getUserService().delete(new com.javafast.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getRoleService().findList(new Role(new com.javafast.modules.sys.entity.User(null, userId)))){
