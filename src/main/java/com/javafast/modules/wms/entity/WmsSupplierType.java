 ...
 * @version 2017-07-04
 */
public class WmsSupplierType extends TreeEntity<WmsSupplierType> {
	
	private static final long serialVersionUID = 1L;
	private WmsSupplierType parent;		// 上级分类
	private String parentIds;		// 所有父级编号
	private String name;		// 分类名称
	private Integer sort;		// 排序
	
	public WmsSupplierType() {
		super();
	}

	public WmsSupplierType(String id){
		super(id);
	}

	@JsonBackReference
	public WmsSupplierType getParent() {
		return parent;
	}

	public void setParent(WmsSupplierType parent) {
		this.parent = parent;
	}
