 ...
 * @version 2017-07-07
 */
public class WmsInstock extends DataEntity<WmsInstock> {
	
	private static final long serialVersionUID = 1L;
	private String instockType;    //入库类型：0：采购入库，1：销退入库, 2:调拨入库
	...
	private List<WmsInstockDetail> wmsInstockDetailList = Lists.newArrayList();		// 子表列表
	
	private WmsPurchase purchase;//关联采购单号
	
	public WmsInstock() {
		super();
	}

	public WmsInstock(String id){
		super(id);
	}
	...
	@ExcelField(title="入库仓库", align=2, sort=9, fieldType=WmsWarehouse.class, value="warehouse.name")
	...
	public List<WmsInstockDetail> getWmsInstockDetailList() {
		return wmsInstockDetailList;
	}

	public void setWmsInstockDetailList(List<WmsInstockDetail> wmsInstockDetailList) {
		this.wmsInstockDetailList = wmsInstockDetailList;
	}
	...
	@Length(min=1, max=1, message="入库类型长度必须介于 1 和 1 之间")
	@ExcelField(title="入库类型", dictType="instock_type", align=2, sort=1)
