 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/report/productReport")
public class ProductReportController extends BaseController {
	 ...
	 * @return
	 */
	@RequiresPermissions("report:productReport:report")
	@RequestMapping(value = "list")
	public String report(CrmReport crmReport, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		List<CrmReport> crmReportList = crmReportService.findProductReportList(crmReport);
		model.addAttribute("crmReportList", crmReportList);
				
		return "modules/report/productReport";
	}
