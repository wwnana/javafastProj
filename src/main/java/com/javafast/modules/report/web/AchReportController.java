 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/report/achReport")
public class AchReportController extends BaseController {
	 ...
	 * @return
	 */
	@RequiresPermissions("report:achReport:report")
	...
	public String achReport(CrmReport crmReport, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		List<CrmReport> crmReportList = crmReportService.findAchReportList(crmReport);
		model.addAttribute("crmReportList", crmReportList);
				
		return "modules/report/achReport";
	}
