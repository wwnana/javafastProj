...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	public static final String DATA_SCOPE_OFFICE = "5";    //5：所在部门数据
	public static final String DATA_SCOPE_SELF = "8";   //8：仅本人数据
	public static final String DATA_SCOPE_CUSTOM = "9";//自定义，暂不开放功能
