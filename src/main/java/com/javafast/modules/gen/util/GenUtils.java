package com.javafast.modules.gen.util;
...
import com.javafast.modules.gen.entity.GenCategory;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenTable genTable){
		...
		model.put("pageModel", genTable.getPageModel());
		model.put("treeData", genTable.getTreeData());
