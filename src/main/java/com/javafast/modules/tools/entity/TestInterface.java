package com.javafast.modules.tools.entity;
...
public class TestInterface extends DataEntity<TestInterface> {
	...
	@Length(min=0, max=300, message="请求URL长度必须介于 0 和 300 之间")
	...
	@Length(min=0, max=1000, message="请求body长度必须介于 0 和 1000 之间")
	...
	@Length(min=0, max=10000, message="备注长度必须介于 0 和 10000 之间")
	...
	@Length(min=0, max=10000, message="接口详情长度必须介于 0 和 10000 之间")
	@ExcelField(title="接口详情", align=2, sort=8)
