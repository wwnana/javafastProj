package com.javafast.modules.tools.service;
...
import com.javafast.modules.tools.dao.TestInterfaceDao;
...
public class TestInterfaceService extends CrudService<TestInterfaceDao, TestInterface> {
	...
	public void save(TestInterface testInterface) {
		//文本域转码
		if (testInterface.getContents()!=null){
			testInterface.setContents(StringEscapeUtils.unescapeHtml4(testInterface.getContents()));
		}
