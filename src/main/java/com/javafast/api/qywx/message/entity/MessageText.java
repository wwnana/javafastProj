package com.javafast.api.qywx.message.entity;
...
public class MessageText {
	...
	private String msgtype;//(必须)消息类型，此时固定为：text
	private int agentid;//(必须)企业应用的id，整型。可在应用的设置页面查看
	private MessageTextData text;//(必须)消息内容
	...
	public MessageTextData getText() {
		return text;
	}
	public void setText(MessageTextData text) {
		this.text = text;
	}
