...
<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="dealBatch()" title="${title }"><i class="fa ${icon==null?'fa-file-text-o':icon}"></i> ${label==null?'':label}</button>
                        </button>
