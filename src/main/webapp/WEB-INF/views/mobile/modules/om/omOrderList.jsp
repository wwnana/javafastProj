...
<html>
  <head>
    ...
    <script type="text/javascript">
    	function toSearch(){
    		window.location.href = "${ctx}/mobile/om/omOrder/search";
    	}
    	var page_no = 1;//当前页
    	...
    	function loadData(){	
    	    ...
    	    $.ajax({
        		url:"${ctx}/mobile/om/omOrder/listData",
        		data: {pageNo:page_no, no:'${omOrder.no}', status:'${omOrder.status}', ownById:'${omOrder.ownBy.id}'},
        		type:"POST",
    	...
    	function setData(data){
    		...
    		for(var i=0;i<data.length;i++){
    			...
    			html += "<div class=\"weui-media-box weui-media-box_text\" onclick=\"viewData('"+ data[i].id +"','"+ data[i].no +"')\" >";
    			...
    			html += "<li class=\"weui-media-box__info__meta weui-media-box__info__meta_extra\">"+ ownByName +"</li>";
    	...
    	function viewData(id, name){
    		window.location.href="${ctx}/mobile/om/omOrder/index?id="+id;
    	}
  ...
  <body ontouchstart>
  	<div class="page">
      <div class="page__bd">
        <mobile:searchBar modelName="omOrder" url="${ctx}/mobile/om/omOrder"></mobile:searchBar>
     ...
     <div class="weui-tabbar">
		...
		<a href="${ctx}/mobile/om/omOrder/form" class="weui-tabbar__item weui-navbar__item">
	          <p class="">新建订单</p>
		</a>
		</shiro:hasPermission>
		<a href="${ctx}/mobile/om/omOrder/search" class="weui-tabbar__item weui-navbar__item">
	          <p class="">查询</p>
		</a>
	 </div>
  </body>
