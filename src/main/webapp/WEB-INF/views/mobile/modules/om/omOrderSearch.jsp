...
<html>
  ...
  <body ontouchstart>
     ...
     <div class="page-content">
     	<form:form id="inputForm" modelAttribute="omOrder" action="${ctx}/mobile/om/omOrder/" method="post" class="form-horizontal">
		
		<div class="weui-cells weui-cells_form">
	      	<div class="weui-cell">
	        	<div class="weui-cell__hd"><label class="weui-label">订单标题</label></div>
		        <div class="weui-cell__bd">
		          <form:input path="name" htmlEscape="false" maxlength="50" class="weui-input" placeholder="请输入订单标题"/>
		        </div>
	      	</div>
	 ...
	 <div class="weui-tabbar">
		...
		<a href="${ctx}/mobile/om/omOrder" class="weui-tabbar__item weui-navbar__item">
	          	返回
		</a>
	 </div>
  </body>
