...
<html>
  ...
  <body ontouchstart>
     ...
     <div class="page-content">
     	<form:form id="inputForm" modelAttribute="crmCustomer" action="${ctx}/mobile/crm/crmCustomerPool/" method="post" class="form-horizontal">
		...
		<div class="weui-cells weui-cells_form">
	      	...
	      	<div class="weui-cell">
		        ...
		        <div class="weui-cell__bd">
		          <form:select path="customerType" class="weui-input">
	      	...
	      	<div class="weui-cell">
		        ...
		        <div class="weui-cell__bd">
		          <form:select path="customerStatus" class="weui-input">
		          	<form:option value="" label="---请选择---"/>
	      	...
	      	<div class="weui-cell">
		        ...
		        <div class="weui-cell__bd">
		          	<form:select path="customerLevel" class="weui-input">
		          		<form:option value="" label="---请选择---"/>
	 ...
	 <div class="weui-tabbar">
		...
		<a href="${ctx}/mobile/crm/crmCustomerPool" class="weui-tabbar__item weui-navbar__item">
	          	返回
		</a>
	 </div>
  </body>
