...
<body ontouchstart>
    ...
    <div class="weui-tab">
      <div class="weui-navbar">
        ...
        <a class="weui-navbar__item weui-bar__item_on" href="${ctx}/mobile/crm/crmCustomer/indexContacterList?id=${crmCustomer.id}">
          	联系人
        </a>
          ...
          <div class="content-padded">
          	...
          	<div class="weui-panel weui-panel_access">
		        ...
		        <div class="weui-panel__bd">
		          ...
		          <div class="weui-media-box weui-media-box_text" onclick="javascript:window.location.href='${ctx}/mobile/crm/crmContacter/index?id=${crmContacter.id}'">
    ...
    <div class="weui-tabbar">
		...
		<a href="${ctx}/mobile/crm/crmContacter/form?customer.id=${crmCustomer.id}" class="weui-tabbar__item weui-navbar__item">
	          <p class="">新建联系人</p>
		</a>
		</shiro:hasPermission>
