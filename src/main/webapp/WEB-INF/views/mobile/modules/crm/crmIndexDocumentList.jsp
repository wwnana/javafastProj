...
<body ontouchstart>
    ...
    <div class="weui-tab">
      <div class="weui-navbar">
        ...
        <a class="weui-navbar__item weui-bar__item_on" href="${ctx}/mobile/crm/crmCustomer/indexDocumentList?id=${crmCustomer.id}">
          	附件
        </a>
        ...
        <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active infinite">
          ...
          <div class="content-padded">
          	...
          	<div class="weui-panel weui-panel_access">
		        ...
		        <div class="weui-panel__bd">
				  <c:forEach items="${list}" var="crmDocument">	
		          <div class="weui-media-box weui-media-box_text" onclick="javascript:window.location.href='${crmDocument.content}'">
		            <h4 class="weui-media-box__title">${crmDocument.name}</h4>
		            <p class="weui-media-box__desc">${crmDocument.createBy.name} | <fmt:formatDate value="${crmDocument.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></p>
		          </div>
		          </c:forEach>
		        </div>
      		</div>
