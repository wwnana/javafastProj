...
<html>
  ...
  <body ontouchstart>
     ...
     <div class="page-content">
     	<form:form id="inputForm" modelAttribute="crmService" action="${ctx}/mobile/crm/crmService/" method="post" class="form-horizontal">
	 ...
	 <div class="weui-tabbar">
		...
		<a href="${ctx}/mobile/crm/crmService" class="weui-tabbar__item weui-navbar__item">
	          	返回
		</a>
	 </div>
  </body>
