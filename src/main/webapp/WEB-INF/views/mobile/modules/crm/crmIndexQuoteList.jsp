...
<body ontouchstart>
    ...
    <div class="weui-tab">
      <div class="weui-navbar">
        ...
        <a class="weui-navbar__item weui-bar__item_on" href="${ctx}/mobile/crm/crmCustomer/indexQuoteList?id=${crmCustomer.id}">
          	报价
        </a>
          ...
          <div class="content-padded">
          	...
          	<div class="weui-panel weui-panel_access">
		        ...
		        <div class="weui-panel__bd">
		          ...
		          <div class="weui-media-box weui-media-box_text"  onclick="javascript:window.location.href='${ctx}/mobile/crm/crmQuote/view?id=${crmQuote.id}'">
		            <h4 class="weui-media-box__title">${crmQuote.amount}</h4>
		            <p class="weui-media-box__desc">${crmQuote.customer.name} | ${crmQuote.ownBy.name}</p>
