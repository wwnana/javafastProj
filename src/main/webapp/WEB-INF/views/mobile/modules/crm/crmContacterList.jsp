...
<html>
  <head>
    ...
    <script type="text/javascript">
    	function toSearch(){
    		window.location.href = "${ctx}/mobile/crm/crmContacter/search";
    	}
    	var page_no = 1;//当前页
    	...
    	function loadData(){	
    	    ...
    	    $.ajax({
        		url:"${ctx}/mobile/crm/crmContacter/listData",
        		data: {pageNo:page_no, name:'${crmContacter.name}', mobile:'${crmContacter.mobile}'},
        		type:"POST",
    	...
    	function setData(data){
    		...
    		for(var i=0;i<data.length;i++){
    			...
    			html += "<p class=\"weui-media-box__desc\">"+data[i].mobile +"</p>";
    			html += "</div>";
    		}
  ...
  <body ontouchstart>
     ...
     <div class="page">
      <div class="page__bd">
        <mobile:searchBar modelName="crmContacter" url="${ctx}/mobile/crm/crmContacter"></mobile:searchBar>
     ...
     <div class="weui-tabbar">
		...
		<a href="${ctx}/mobile/crm/crmContacter/form" class="weui-tabbar__item weui-navbar__item">
	          <p class="">新建联系人</p>
		</a>
		</shiro:hasPermission>
		<a href="${ctx}/mobile/crm/crmContacter/search" class="weui-tabbar__item weui-navbar__item">
	          <p class="">高级查询</p>
		</a>
	 </div>
  </body>
