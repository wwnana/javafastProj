...
<body ontouchstart>
    ...
    <div class="weui-tab">
      <div class="weui-navbar">
        ...
        <a class="weui-navbar__item weui-bar__item_on" href="${ctx}/mobile/crm/crmCustomer/indexChanceList?id=${crmCustomer.id}">
          	商机
        </a>
          ...
          <div class="content-padded">
          	...
          	<div class="weui-panel weui-panel_access">
		        ...
		        <div class="weui-panel__bd">
		          ...
		          <div class="weui-media-box weui-media-box_text" onclick="javascript:window.location.href='${ctx}/mobile/crm/crmChance/index?id=${crmChance.id}'">
		            <h4 class="weui-media-box__title">${fns:abbr(crmChance.name,50)}</h4>
		            <p class="weui-media-box__desc">${fns:getDictLabel(crmChance.periodType, 'period_type', '')} | ${crmChance.ownBy.name}</p>
		          </div>
		          </c:forEach>
		        </div>
      		</div>
    ...
    <div class="weui-tabbar">
		<a href="${ctx}/mobile/crm/crmChance/form?customer.id=${crmCustomer.id}" class="weui-tabbar__item weui-navbar__item">
	          <p class="">新建商机</p>
		</a>
