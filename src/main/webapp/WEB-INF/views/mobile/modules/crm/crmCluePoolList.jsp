...
<html>
  <head>
    ...
    <script type="text/javascript">
    	...
    	function loadData(){	
    	    ...
    	    $.ajax({
        		url:"${ctx}/mobile/crm/crmCluePool/listData",
        		data: {pageNo:page_no, name:'${crmClue.name}'},
        		type:"POST",
    	...
    	function viewData(id, name){
    		window.location.href="${ctx}/mobile/crm/crmCluePool/view?id="+id;
    	}
  ...
  <body ontouchstart>
  	<div class="page">
      <div class="page__bd">
        <mobile:searchBar modelName="crmClue" url="${ctx}/mobile/crm/crmCluePool"></mobile:searchBar>
      ...
      <div class="weui-tabbar">
		...
		<a href="${ctx}/mobile/crm/crmCluePool/form" class="weui-tabbar__item weui-navbar__item">
	          <p class="">新建线索</p>
		</a>
