...
<html>
  <head>
    ...
    <script type="text/javascript">
    	...
    	function toSearch(){
    		window.location.href = "${ctx}/mobile/crm/crmCustomer/search";
    	}
    	var page_no = 1;//当前页
    	...
    	function loadData(){	
    	    ...
    	    $.ajax({
        		url:"${ctx}/mobile/crm/crmCustomer/listData",
        		data: {pageNo:page_no, name:'${crmCustomer.name}', customerType:'${crmCustomer.customerType}', customerStatus:'${crmCustomer.customerStatus}', customerLevel:'${crmCustomer.customerLevel}', ownById:'${crmCustomer.ownBy.id}'},
        		type:"POST",
  ...
  <div class="page">
    <div class="page__bd">
        <mobile:searchBar modelName="crmCustomer" url="${ctx}/mobile/crm/crmCustomer"></mobile:searchBar>
     ...
     <div class="weui-tabbar">
		...
		<a href="${ctx}/mobile/crm/crmCustomerRecycle" class="weui-tabbar__item weui-navbar__item">
	          <p class="">回收站</p>
		</a>
		<a href="${ctx}/mobile/crm/crmCustomer/search" class="weui-tabbar__item weui-navbar__item">
	          <p class="">高级查询</p>
		</a>
	 </div>
	</div>
