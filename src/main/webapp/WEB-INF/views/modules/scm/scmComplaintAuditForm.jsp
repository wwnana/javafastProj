...
<div class="ibox">
	...
	<form:form id="inputForm" modelAttribute="scmComplaint" action="${ctx}/scm/scmComplaint/auditSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>			
			...
			<tr>				
				...
				<td class="width-35">
					<div class="input-group date datepicker input-xlarge">
						<input name="dealDate" type="text" readonly="readonly" class="form-control required" value="<fmt:formatDate value="${scmComplaint.dealDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true});" >
				...
				<td class="width-35">
					<form:select path="satisfyType" cssClass="form-control input-medium required">
		...
		<br>
			<div class="form-actions">
				<shiro:hasPermission name="scm:scmComplaint:edit"><input id="btnSubmit" class="btn btn-success" type="submit" value="审 核"/>&nbsp;</shiro:hasPermission>
