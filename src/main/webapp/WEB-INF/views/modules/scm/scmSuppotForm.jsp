...
<div class="ibox">
	<div class="ibox-title">
		<h5>客户服务${not empty scmSuppot.id?'修改':'添加'}</h5>
	</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group">
								<input id="customerId" name="customer.id" type="hidden" value="${scmSuppot.customer.id}"/>
								<input type="text" id="customerName" name="customer.name" readonly="readonly" value="${scmSuppot.customer.name}" class="form-control required">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group">
								<input id="omContractId" name="omContract.id" type="hidden" value="${scmSuppot.omContract.id}"/>
								<input type="text" id="omContractName" name="omContract.name" readonly="readonly" value="${scmSuppot.omContract.name}" class="form-control">
								<span class="input-group-addon" id="customerButton"><i class="fa fa-search"></i></span>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group date datepicker">
								<input name="endDate" type="text" readonly="readonly" class="form-control required" value="<fmt:formatDate value="${scmSuppot.endDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true});" >
