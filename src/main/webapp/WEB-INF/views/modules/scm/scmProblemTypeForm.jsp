...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="scmProblemType" action="${ctx}/scm/scmProblemType/save" method="post" class="form-horizontal">
	<form:hidden path="id"/>
	...
	<table class="table table-bordered table-condensed dataTables-example dataTable no-footer">
		<tbody>
			<tr>
				...
				<td class="width-35">
					<sys:treeselect id="parent" name="parent.id" value="${scmProblemType.parent.id}" labelName="parent.name" labelValue="${scmProblemType.parent.name}"
						title="上级分类" url="/scm/scmProblemType/treeData" extId="${scmProblemType.id}" cssClass="form-control" allowClear="true"/>
				</td>
