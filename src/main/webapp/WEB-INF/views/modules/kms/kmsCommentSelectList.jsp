	...
	<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="kmsComment" action="${ctx}/kms/kmsComment/selectList" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-bordered table-striped table-hover">
					...
					<c:forEach items="${page.list}" var="kmsComment">
						<tr>
							...
							<td class="codelabel">${kmsComment.content}</td>
							<td>${kmsComment.createBy.name}</td>
							<td><fmt:formatDate value="${kmsComment.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							<td>
