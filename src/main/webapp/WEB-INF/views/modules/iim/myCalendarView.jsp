...
<style type="text/css">
	#calendar{ margin:10px auto 10px auto;width:95%;height:50%;}
	.fancy{width:300px; height:200px}
	.fancy h3{height:30px; line-height:30px; border-bottom:1px solid #d3d3d3; font-size:14px}
	.fancy form{padding:10px}
	.fancy p{height:28px; line-height:28px; padding:4px; color:#999}
	.input{height:20px; line-height:20px; padding:2px; border:1px solid #d3d3d3; width:80px}
	...
	.sub_btn{height:32px; line-height:32px; padding-top:6px; border-top:1px solid #f0f0f0; position:relative}
	.sub_btn .del{left:2px}
</style>
