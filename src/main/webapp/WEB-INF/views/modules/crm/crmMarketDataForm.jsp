			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						<label class="col-sm-2 control-label"><font color="red">*</font> 展示标题：</label>
						<div class="col-sm-8">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<form:hidden id="coverImage" path="coverImage" htmlEscape="false" maxlength="255" />
							<sys:ckfinder input="coverImage" type="images" uploadPath="/crm" selectMultiple="false"/>
							<span class="help-inline">建议图片尺寸600*200像素</span>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<form:textarea id="content" path="content" htmlEscape="false" rows="4" maxlength="10000" class="form-control " style="width:100%;height:200px;"/>
