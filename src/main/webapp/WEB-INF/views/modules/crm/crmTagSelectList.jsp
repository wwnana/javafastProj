	...
	<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="crmTag" action="${ctx}/crm/crmTag/selectList" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
					...
					<c:forEach items="${page.list}" var="crmTag">
						<tr>
							...
							<td class="codelabel">${crmTag.name}</td>
							<td>${crmTag.createBy.id}</td>
							<td>
								<shiro:hasPermission name="crm:crmTag:view">
									<a href="#" onclick="openDialogView('查看客户标签', '${ctx}/crm/crmTag/view?id=${crmTag.id}','800px', '500px')" class="btn btn-info btn-xs" title="查看"><i class="fa fa-search-plus"></i> 查看</a>
								</shiro:hasPermission>
							</td>
						</tr>
					</c:forEach>
