	...
	<form:form id="inputForm" modelAttribute="crmCustomerStar" action="${ctx}/crm/crmCustomerStar/save" method="post" class="form-horizontal">
		...
		<tbody>
			<tr>
				...
				<td class="width-35">
					<form:input path="customer.id" htmlEscape="false" maxlength="30" class="form-control input-xlarge"/>
				</td>
				<td class="width-15 active"><label class="pull-right">关注者：</label></td>
				<td class="width-35">
					<form:input path="ownBy" htmlEscape="false" maxlength="30" class="form-control input-xlarge"/>
				</td>
			</tr>
			<tr>
			</tr>
