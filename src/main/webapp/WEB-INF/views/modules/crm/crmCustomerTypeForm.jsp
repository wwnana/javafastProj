...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="crmCustomerType" action="${ctx}/crm/crmCustomerType/save" method="post" class="form-horizontal">
	<form:hidden path="id"/>
	...
	<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		...
		<tr>
				...
				<td class="width-35"><sys:treeselect id="parent" name="parent.id" value="${crmCustomerType.parent.id}" labelName="parent.name" labelValue="${crmCustomerType.parent.name}"
							title="上级分类" url="/crm/crmCustomerType/treeData" extId="${crmCustomerType.id}" cssClass="form-control" allowClear="true"/>
				</td>
