	...
	<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="crmDocument" action="${ctx}/crm/crmDocument/selectList" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-bordered table-striped table-hover">
					<thead>
						<tr>
							...
							<th class="sort-column a.content">附件</th>
					...
					<c:forEach items="${page.list}" var="crmDocument">
						<tr>
							...
							<td class="codelabel">${crmDocument.name}</td>
							<td>${crmDocument.content}</td>
							<td><fmt:formatDate value="${crmDocument.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							<td>
								<shiro:hasPermission name="crm:crmDocument:view">
