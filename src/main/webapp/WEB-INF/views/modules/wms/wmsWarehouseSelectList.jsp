...
<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="wmsWarehouse" action="${ctx}/wms/wmsWarehouse/selectList" method="post" class="form-inline">
						...
						<tr>
							...
							<td>
								<shiro:hasPermission name="wms:wmsWarehouse:view">
									<a href="#" onclick="openDialogView('查看仓库', '${ctx}/wms/wmsWarehouse/view?id=${wmsWarehouse.id}','800px', '500px')" class="btn btn-info btn-xs" title="查看"><i class="fa fa-search-plus"></i> 查看</a>
								</shiro:hasPermission>
							</td>
						</tr>
					</c:forEach>
