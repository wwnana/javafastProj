	...
	<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="hrResumeLog" action="${ctx}/hr/hrResumeLog/selectList" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-bordered table-striped table-hover">
					...
					<c:forEach items="${page.list}" var="hrResumeLog">
						<tr>
							...
							<td class="codelabel">${hrResumeLog.note}</td>
							<td>${hrResumeLog.type}</td>
							<td><fmt:formatDate value="${hrResumeLog.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							<td>
								<shiro:hasPermission name="hr:hrResumeLog:view">
									<a href="#" onclick="openDialogView('查看HR日志', '${ctx}/hr/hrResumeLog/view?id=${hrResumeLog.id}','800px', '500px')" class="btn btn-info btn-xs" title="查看"><i class="fa fa-search-plus"></i> 查看</a>
								</shiro:hasPermission>
							</td>
						</tr>
					</c:forEach>
