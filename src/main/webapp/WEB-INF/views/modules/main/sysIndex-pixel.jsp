...
<!-- Demo script --> <script src="${ctxStatic}/assets/demo/demo.js"></script> <!-- / Demo script -->
		...
		<div class="navbar-inner">
			...
			<div class="navbar-header">
				...
				<a href="${ctx}/home" class="navbar-brand">
					<div><img alt="Pixel Admin" src="${ctxStatic}/assets/demo/logo-big-crm.png"></div>
					JavaFast快速开发平台
				</a>
							...
							<li class="nav-icon-btn nav-icon-btn-success dropdown">
								...
								<div class="dropdown-menu widget-messages-alt no-padding" style="width: 300px;">
									<div class="messages-list" id="main-navbar-messages">
										...
										<div class="message">
											<img src="${ctxStatic}/assets/demo/avatars/2.jpg" alt="" class="message-avatar">
										...
										<div class="message">
											<img src="${ctxStatic}/assets/demo/avatars/3.jpg" alt="" class="message-avatar">
										...
										<div class="message">
											<img src="${ctxStatic}/assets/demo/avatars/4.jpg" alt="" class="message-avatar">
										...
										<div class="message">
											<img src="${ctxStatic}/assets/demo/avatars/5.jpg" alt="" class="message-avatar">
											<a href="#" class="message-subject">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</a>
											<div class="message-description">
...
<!-- /3. $END_NAVBAR_ICON_BUTTONS -->
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle user-menu" data-toggle="dropdown">
									<img src="${ctxStatic}/images/app/app_head01.png" alt="">
									<span>John Doe</span>
								</a>
								<ul class="dropdown-menu">
		...
		<div id="main-menu-inner">
			<div class="menu-content top" id="menu-content-demo">
				...
				<div>
					...
					<img src="${ctxStatic}/images/app/app_head01.png" alt="" class="">
					<div class="btn-group">
						<a href="#" class="btn btn-xs btn-success btn-outline dark"><i class="fa fa-envelope"></i></a>
						<a href="#" class="btn btn-xs btn-success btn-outline dark"><i class="fa fa-user"></i></a>
						<a href="#" class="btn btn-xs btn-success btn-outline dark"><i class="fa fa-cog"></i></a>
			...
			<div class="menu-content">
				<a href="pages-invoice.html" class="btn btn-success btn-block btn-outline dark">Create Invoice</a>
			</div>
		</div> <!-- / #main-menu-inner -->
	</div> <!-- / #main-menu -->
<!-- /4. $MAIN_MENU -->
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-8">
					<div class="row">
						...
						<div class="pull-right col-xs-12 col-sm-auto"><a href="#" class="btn btn-success btn-labeled" style="width: 100%;"><span class="btn-label icon fa fa-plus"></span>Create project</a></div>
				...
				<div class="panel panel-warning" id="dashboard-recent">
					...
					<div class="tab-content">
						...
						<div class="widget-comments panel-body tab-pane no-padding fade active in" id="dashboard-recent-comments">
							...
							<div class="panel-padding no-padding-vr">
								<div class="comment">
									<img src="${ctxStatic}/assets/demo/avatars/5.jpg" alt="" class="comment-avatar">
								...
								<div class="comment">
									<img src="${ctxStatic}/assets/demo/avatars/3.jpg" alt="" class="comment-avatar">
									<div class="comment-body">
										<div class="comment-by">
								...
								<div class="comment">
									<img src="${ctxStatic}/assets/demo/avatars/2.jpg" alt="" class="comment-avatar">
									<div class="comment-body">
										<div class="comment-by">
								...
								<div class="comment">
									<img src="${ctxStatic}/assets/demo/avatars/4.jpg" alt="" class="comment-avatar">
									<div class="comment-body">
										<div class="comment-by">
						...
						<div class="widget-threads panel-body tab-pane no-padding fade" id="dashboard-recent-threads">
							<div class="panel-padding no-padding-vr">
								<div class="thread">
									<img src="${ctxStatic}/assets/demo/avatars/2.jpg" alt="" class="thread-avatar">
								...
								<div class="thread">
									<img src="${ctxStatic}/assets/demo/avatars/3.jpg" alt="" class="thread-avatar">
									<div class="thread-body">
										<span class="thread-time">14h</span>
										<a href="#" class="thread-title">Lorem ipsum dolor sit amet</a>
								...
								<div class="thread">
									<img src="${ctxStatic}/assets/demo/avatars/4.jpg" alt="" class="thread-avatar">
									<div class="thread-body">
										<span class="thread-time">14h</span>
										<a href="#" class="thread-title">Lorem ipsum dolor sit amet</a>
								...
								<div class="thread">
									<img src="${ctxStatic}/assets/demo/avatars/5.jpg" alt="" class="thread-avatar">
									<div class="thread-body">
										<span class="thread-time">14h</span>
										<a href="#" class="thread-title">Lorem ipsum dolor sit amet</a>
					...
					<table class="table">
						...
						<tbody class="valign-middle">
							<tr>
								<td>1</td>
								<td>
									<img src="${ctxStatic}/assets/demo/avatars/2.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@rjang</a>
								</td>
								<td>Robert Jang</td>
							...
							<tr>
								<td>2</td>
								<td>
									<img src="${ctxStatic}/assets/demo/avatars/3.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@mbortz</a>
								</td>
							...
							<tr>
								<td>3</td>
								<td>
									<img src="${ctxStatic}/assets/demo/avatars/4.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@towens</a>
								</td>
								<td>Timothy Owens</td>
							...
							<tr>
								<td>4</td>
								<td>
									<img src="${ctxStatic}/assets/demo/avatars/5.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@dsteiner</a>
								</td>
			...
			<div class="col-md-5">
				...
				<div class="panel widget-tasks panel-dark-gray">
					<div class="panel-heading">
						...
						<div class="panel-heading-controls">
							<button class="btn btn-xs btn-success btn-outline dark" id="clear-completed-tasks"><i class="fa fa-eraser text-success"></i> Clear completed tasks</button>
						</div>
					</div> <!-- / .panel-heading -->
...
<!--[if !IE]> -->
	<script type="text/javascript"> window.jQuery || document.write('<script src="${ctxStatic}/assets/js/jquery-1.12.4.min.js">'+"<"+"/script>"); </script>
<!-- <![endif]-->
<!--[if lte IE 9]>
	<script type="text/javascript"> window.jQuery || document.write('<script src="${ctxStatic}/assets/js/jquery-1.12.4.min.js">'+"<"+"/script>"); </script>
<![endif]-->
