...
<!-- Demo script --> <script src="${ctxStatic}/assets/demo/demo2.js"></script> <!-- / Demo script -->
	...
	<div class="signin-container">
		...
		<div class="signin-info">
			<a href="#" class="logo">
				<img src="${ctxStatic}/assets/demo/logo-big-jf1.png" alt="" style="margin-top: -5px;width: 30px;border-radius: 3px;">&nbsp;
				项目管理软件
			</a> <!-- / .logo -->
			<div class="slogan">
				让软件开发极限提速！
		...
		<div class="signin-form">
			...
			<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
				...
				<div class="form-group w-icon">
					<input type="text" id="username" name="username" class="form-control input-lg required" placeholder="用户名" value="admin">
					<span class="fa fa-user signin-form-icon"></span>
				</div>

				<div class="form-group w-icon">
					<input type="password" id="password" name="password" class="form-control input-lg required" placeholder="密码" value="admin">
