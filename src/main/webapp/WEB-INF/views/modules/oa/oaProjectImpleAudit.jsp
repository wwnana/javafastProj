...
<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<form:form id="inputForm" modelAttribute="oaProjectImple" action="${ctx}/oa/oaProjectImple/saveAudit" method="post" class="form-horizontal">
					<form:hidden path="id"/>
					...
					<div class="form-actions">
						<shiro:hasPermission name="oa:oaProjectImple:edit">
							<c:if test="${oaProjectImple.act.taskDefKey eq 'apply_end'}">
								<input id="btnSubmit" class="btn btn-success" type="submit" value="兑 现" onclick="$('#flag').val('yes')"/>&nbsp;
							</c:if>
							<c:if test="${oaProjectImple.act.taskDefKey ne 'apply_end'}">
					...
					<act:histoicFlow procInsId="${oaProjectImple.act.procInsId}"/>
				</form:form>
				<br/>
			</div>
		</div>
