	...
	<div class="">
		<div class="">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="oaProjImpl" action="${ctx}/oa/oaProjImpl/selectList" method="post" class="form-inline">
						...
						<tr>
							...
							<td>
								<shiro:hasPermission name="oa:oaProjImpl:view">
									<a href="#" onclick="openDialogView('查看项目实施流程表', '${ctx}/oa/oaProjImpl/view?id=${oaProjImpl.id}','800px', '500px')" class="btn btn-info btn-xs" title="查看"><i class="fa fa-search-plus"></i> 查看</a>
								</shiro:hasPermission>
							</td>
						</tr>
					</c:forEach>
