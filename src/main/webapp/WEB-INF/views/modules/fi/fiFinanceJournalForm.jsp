	...
	<form:form id="inputForm" modelAttribute="fiFinanceJournal" action="${ctx}/fi/fiFinanceJournal/save" method="post" class="form-horizontal">
		...
		<tbody>
			<tr>
				...
				<td class="width-35">
					<form:input path="fiaccount.id" htmlEscape="false" maxlength="30" class="form-control input-xlarge"/>
				</td>
				<td class="width-15 active"><label class="pull-right">交易类别：</label></td>
				<td class="width-35">
					<form:select path="dealType" cssClass="form-control input-xlarge">
			...
			<tr>
				...
				<td class="width-35">
					<input name="dealDate" type="text" readonly="readonly" maxlength="20" class="laydate-icon form-control layer-date input-xlarge "
						value="<fmt:formatDate value="${fiFinanceJournal.dealDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
						onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
				</td>
				<td class="width-15 active"><label class="pull-right">资金类别：</label></td>
				<td class="width-35">
					<form:select path="moneyType" cssClass="form-control input-xlarge">
						<form:option value="" label=""/>
			...
			<tr>
				...
				<td class="width-35">
					<form:input path="money" htmlEscape="false" class="form-control input-xlarge"/>
				</td>
			...
			<tr>
				...
				<td class="width-35">
					<form:input path="balance" htmlEscape="false" class="form-control input-xlarge"/>
				</td>
			</tr>
		</tbody>
		</table>
