...
<script type="text/javascript">
		$(document).ready(function() {
			...
			$('.navigation > .mm-dropdown').hover(function(){
				$(this).addClass("mm-dropdown-root");
            },function(){
           		$(this).removeClass("mm-dropdown-root");
            });
		});
	...
	<ul class="navigation">
		...
		<input type="hidden" id="menu-${param.parentId}" value="2" />
		<t:hplusMenu menu="${fns:getTopMenuByParent(param.parentId)}"></t:hplusMenu>
	</ul>
