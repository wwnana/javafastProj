		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		     ...
		     <tr>
		         ...
		         <td><form:input path="name" htmlEscape="false" maxlength="30" class="form-control required"/></td>
		    </tr>		      
		     <tr>
		         ...
		         <td><input id="oldLoginName" name="oldLoginName" type="hidden" value="${user.loginName}">
					 ...
					 <span class="help-inline">建议使用手机号</span>
				</td>
		        ...
		        <td>
		        	...
		        	<span class="help-inline">建议填写，方便忘记密码后找回</span>
		        </td>
			</tr>		      
		    <tr>
		     ...
		     <tr>
		         ...
		         <td><form:input path="email" htmlEscape="false" maxlength="50" class="form-control email"/></td>
		         <td class="active"><label class="pull-right">电话:</label></td>
		         <td><form:input path="phone" htmlEscape="false" maxlength="50" class="form-control"/></td>
		     </tr>		      
		     <tr>
		         <td class="active"><label class="pull-right">用户类型:</label></td>
		         <td><form:select path="userType"  class="form-control input-large">
				...
				<td class="active"><label class="pull-right">是否允许登录:</label></td>
		         <td>
		         	<form:select path="loginFlag"  class="form-control input-large">
