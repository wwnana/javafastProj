...
<body>
	<div id="importBox" class="hide">
		<form id="importForm" action="${ctx}/sys/user/import" method="post" enctype="multipart/form-data"
			...
			<input id="btnImportSubmit" class="btn btn-success" type="submit" value="   导    入   "/>
	...
	<form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/user/listData" method="post" class="breadcrumb form-search ">
		...
		<ul class="ul-form">
			...
			<li class="btns"><input id="btnSubmit" class="btn btn-success" type="submit" value="查询" onclick="return page();"/>
