...
{name:'其他', cityList:[		   
{name:'全部', areaList:['全部']},		   
{name:'亚洲', areaList:['蒙古','朝鲜','韩国','日本','越南','老挝','柬埔寨','泰国','缅甸','马来西亚','新加坡','印度尼西亚','文莱','菲律宾','东帝汶','印度','孟加拉国','不丹','尼泊尔','巴基斯坦','斯里兰卡','马尔代夫','沙特阿拉伯','卡塔尔','巴林','科威特','阿拉伯联合酋长国','阿曼','也门','土耳其','塞蒲路斯','黎巴嫩','叙利亚','以色列','巴勒斯坦','约旦','伊拉克','伊朗','阿富汗','亚美尼亚','阿塞拜疆','土库曼斯坦','塔吉克斯坦','吉尔吉斯斯坦','乌兹别克斯坦','哈萨克斯坦','其他']},	
{name:'非洲', areaList:['埃及','苏丹','利比亚','突尼斯','阿尔及利亚','摩洛哥','亚速尔群岛','马德拉群岛','埃塞俄比亚','厄立特里亚','索马里','吉布提','肯尼亚','坦桑尼亚','乌干达','卢旺达','布隆迪和塞舌尔','毛里塔尼亚','西撒哈拉','塞内加尔','冈比亚','马里','布基纳法索','几内亚','几内亚比绍','佛得角','塞拉利昂','利比里亚','科特迪瓦','加纳，多哥','贝宁','尼日尔','尼日利亚','加那利群岛','乍得','中非','喀麦隆','赤道几内亚','加蓬','刚果（布）','刚果（金）','圣多美','普林西比','有时也把赞比亚','津巴布韦和马拉维','赞比亚','安哥拉','津巴布韦','马拉维','莫桑比克','博茨瓦纳','纳米比亚','南非','斯威士兰','莱索托','马达加斯加','科摩罗','毛里求斯','留尼汪岛','圣赫勒拿岛','阿森松岛','其他']},	
{name:'欧洲', areaList:['芬兰','瑞典','挪威','冰岛','丹麦 法罗群岛（丹）','爱沙尼亚','拉脱维亚','立陶宛','白俄罗斯','俄罗斯','乌克兰','摩尔多瓦','波兰','捷克','斯洛伐克','匈牙利','德国','奥地利','瑞士','列支敦士登','英国','爱尔兰','荷兰','比利时','卢森堡','法国','摩纳哥','罗马尼亚','保加利亚','塞尔维亚','马其顿','阿尔巴尼亚','希腊','斯洛文尼亚','克罗地亚','波斯尼亚','墨塞哥维那 ','意大利','梵蒂冈','圣马力诺','马耳他','西班牙','葡萄牙','安道尔','其他']},		   
{name:'美洲', areaList:['阿根廷','巴哈马','伯利兹','美国','玻利维亚','巴西','巴巴多斯','加拿大','哥伦比亚','智利','哥斯达黎加','古巴','委内瑞拉','萨尔瓦多','厄瓜多尔','格林纳达','危地马拉','圭亚那','洪都拉斯','海地','牙买加','圣卢西亚','墨西哥','尼加拉瓜','巴拿马','秘鲁','乌拉圭','巴拉圭','苏里南','多米尼加','多米尼克','圣文森特','格林纳丁斯','特立尼达','多巴哥','安提瓜','巴布达','圣基茨','尼维斯','其他']},	   
{name:'大洋洲', areaList:['澳大利亚','瑙鲁共和国','瓦努阿图共和国','马绍尔群岛共和国','汤加王国','新西兰','图瓦卢','基里巴斯共和国','所罗门群岛','斐济共和国','萨摩亚','巴布亚新几内亚独立国','帕劳共和国','斐济','密克罗尼西亚联邦','其他']}
]}
];