...
layui.define(['jquery', 'layer', 'laytpl', 'upload'], function(exports){
  ...
  var errorImg = "'http://www.yee800.com/user.png'";
  ...
  var layimClose, popmin = function(content){
    ...
    return layer.open({
      ...
      ,shift: 2
      ,offset: 'rb'
      ,content: '<img src="'+ (cache.mine.avatar||(layui.cache.dir+'css/pc/layim/skin/logo.jpg')) +'" onerror="this.src='+errorImg+'" ><span>'+ (content||cache.base.title||'内部沟通') +'</span>'
